...
namespace mathMagic
{
    internal class Program
    {
        ...
        private static void rightFeedback()
        {
            ...
            {
                case 1:
                    Console.WriteLine("Correct! Want to try again?");
                    break;
                case 2:
                    Console.WriteLine("Well done you genuis!");
                    break;
                case 3:
                    Console.WriteLine("Good stuff.");
                    break;
                case 4:
                    Console.WriteLine("Oh HECK yes. You got it.");
                    break;
                case 5:
                    Console.WriteLine("Yup!");
                    break;
                case 6:
                    Console.WriteLine("Niceeeeeeeeeee");
                    break;
                case 7:
                    Console.WriteLine("GGWP");
                    break;
                default:
                    Console.WriteLine("+10000 for team you");
                    break;
            }
        }
